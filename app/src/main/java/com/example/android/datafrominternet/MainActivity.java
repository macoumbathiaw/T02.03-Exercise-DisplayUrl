...
public class MainActivity extends AppCompatActivity {
    ...
    String valueFrommSearchBoxEditText = mSearchBoxEditText.getText().toString();
        URL urlToPassTomUrlDisplayTextView = NetworkUtils.buildUrl(valueFrommSearchBoxEditText);

        mUrlDisplayTextView.setText(urlToPassTomUrlDisplayTextView.toString());
